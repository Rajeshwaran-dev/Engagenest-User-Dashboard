...
const UseTemplateModal = ({ onClose, onTemplateSelect, messageType = "single" }) => {
  ...
  const templates = [
    ...
    },
    {
      ...
      maxFileSize: 10,
      variables: [
        { name: "product1", mediaType: "image" },
        { name: "product2", mediaType: "image" }
      ],
    ...
    // Carousel Templates - Video Only
    {
      ...
      maxFileSize: 15,
      variables: [
        { name: "offer1", mediaType: "video" },
        { name: "offer2", mediaType: "video" }
      ],
